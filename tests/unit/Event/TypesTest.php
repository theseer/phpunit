...
final class TypesTest extends TestCase
{
    public function testDefaults(): void
    {
        ...
        self::assertIsIterable($types);
        self::assertEquals([], \iterator_to_array($types));
    }
    ...
    public function testConstructorSetsTypes(): void
    {
        ...
        self::assertIsIterable($types);
        self::assertEquals($composedTypes, \iterator_to_array($types));
    }
    ...
    public function testContainsReturnsFalseWhenEqualTypeHasNotBeenComposed(): void
    {
        ...
        self::assertFalse($types->contains($type));
    }
    ...
    public function testContainsReturnsTrueWhenEqualTypeHasBeenComposed(): void
    {
        ...
        self::assertTrue($types->contains($type));
    }
}
