...
class Info
{
    ...
    /** @var MemoryUsage */
    private $memorySinceStart;

    /** @var DateInterval */
    private $timeSincePrevious;

    /** @var MemoryUsage */
    private $memorySincePrevious;

    public function __construct(Snapshot $current, DateInterval $timeSinceStart, MemoryUsage $memorySinceStart, DateInterval $timeSincePrevious, MemoryUsage $memorySincePrevious)
    {
